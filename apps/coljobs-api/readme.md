...
This Nx Firebase application was generated by [@simondotm/nxfirebase](https://github.com/simondotm/nxfirebase).
...
- `firebase.coljobs-api.json` - Firebase CLI Configuration for this project
...
NxFirebase will add `firebase-admin` and `firebase-functions` to your workspace `package.json` at the `'latest'` version. You may wish to set these to a specific version.
...
See the plugin [README](https://github.com/simondotm/nxfirebase/blob/main/README.md) for more information.
